...
//  AngryBirdClone
//
//  Created by yakup bülbül on 16.08.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate{
  ...
  //  var bird2 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        bird.physicsBody?.collisionBitMask = ColiderType.Bird.rawValue
        ...
        let size  = CGSize(width: boxTexture.size().width / 5.5, height: boxTexture.size().height / 5.5)
        ...
        box1.physicsBody?.contactTestBitMask = ColiderType.Bird.rawValue
        ...
        box2.physicsBody?.contactTestBitMask = ColiderType.Bird.rawValue
        ...
        box3.physicsBody?.contactTestBitMask = ColiderType.Bird.rawValue
        ...
        box4.physicsBody?.contactTestBitMask = ColiderType.Bird.rawValue
        ...
        box5.physicsBody?.contactTestBitMask = ColiderType.Bird.rawValue
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        //bird.physicsBody?.applyImpulse(CGVector(dx: 30, dy: 200))
